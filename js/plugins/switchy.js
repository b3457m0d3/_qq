  ...
  * ====================== */
  ...
  Switchy.prototype = {
    ...
    init: function(){
      ...
      this.$bar.on('click', function(e){
        var currentSliderPosition = that.$slider.position().left,
            ...
            _.log("curr pos:"+currentSliderPosition+"\n");
            _.log("curr opt index:"+currentOptionIndex+"\n");
            _.log("click pos:"+clickPosition+"\n");
            _.log("next opt index:"+nextOptionIndex+"\n");
    ...
    sliderPosition: function(barGrid, optionIndex){
      ...
      var pos = (barGrid * optionIndex) + add;
      return pos;
    },
